    ...
    <div class="px-4 -mt-4">
        ...
        <div class="grid grid-cols-3 gap-3 mb-6">
            <div class="card p-4">
                ...
                <p class="text-xl font-bold text-primary-600"><?php echo e($thisMonthCheckIns); ?></p>
            </div>
            <div class="card p-4">
                <p class="text-xs text-secondary-600 mb-1">Tepat Waktu</p>
                <p class="text-xl font-bold text-success-600"><?php echo e($thisMonthOnTime); ?></p>
            </div>
            <div class="card p-4">
                <p class="text-xs text-secondary-600 mb-1">Terlambat</p>
                <p class="text-xl font-bold text-danger-600"><?php echo e($thisMonthLate); ?></p>
            </div>
        </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card p-4">
                    <div class="flex items-start justify-between mb-2">
                        <div>
                            <p class="font-medium text-secondary-900">
                                <?php echo e($attendance->created_at->isoFormat('dddd, D MMMM YYYY')); ?></p>
                            <p class="text-sm text-secondary-600"><?php echo e($attendance->created_at->format('H:i')); ?> WIB</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between pt-3 border-t border-secondary-100">
                        ...
                        <span
                            class="text-xs font-medium <?php echo e($attendance->type === 'check_in' ? 'text-primary-600' : 'text-secondary-600'); ?>">
...
</div><?php /**PATH C:\Users\putri\Documents\Project\Bored\wengset-absensi\resources\views/livewire/employee/attendance-history.blade.php ENDPATH**/ ?>