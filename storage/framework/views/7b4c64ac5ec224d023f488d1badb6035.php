            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isOwner()): ?>
                        ...
                        <!-- Owner-only menu -->
                        <a href="<?php echo e(route('owner.admin-management')); ?>"
                            class="flex items-center px-4 py-3 rounded-lg hover:bg-secondary-100 <?php echo e(request()->routeIs('owner.admin-management') ? 'bg-primary-50 text-primary-600' : 'text-secondary-700'); ?>">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
