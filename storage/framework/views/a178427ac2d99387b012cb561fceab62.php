<div>
        ...
        <div class="card mb-6 border-2 border-primary-200 bg-primary-50">
            <div class="card-body">
                <div class="flex items-center">
                    <img src="<?php echo e($owner->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode($owner->name)); ?>"
                        alt="Avatar" class="w-16 h-16 rounded-full mr-4 border-4 border-white shadow-lg">
                    <div class="flex-1">
                        <div class="flex items-center">
                            <h3 class="text-lg font-bold text-secondary-900 mr-2"><?php echo e($owner->name); ?></h3>
                            <span class="badge bg-primary-600 text-white">👑 Owner</span>
                        </div>
                        <p class="text-secondary-600 text-sm"><?php echo e($owner->email); ?></p>
                    </div>
    ...
    <div class="card">
        <div class="card-header flex items-center justify-between">
            <h2 class="text-lg font-semibold text-secondary-900">Daftar Admin (<?php echo e($admins->total()); ?>)</h2>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-secondary-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-secondary-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <img src="<?php echo e($admin->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode($admin->name)); ?>"
                                        alt="Avatar" class="w-10 h-10 rounded-full mr-3">
                                    <div>
                                        <div class="text-sm font-medium text-secondary-900"><?php echo e($admin->name); ?></div>
                                        <div class="text-xs text-secondary-500">ID: <?php echo e($admin->id); ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                <button wire:click="demoteAdmin(<?php echo e($admin->id); ?>)"
                                    wire:confirm="Apakah Anda yakin ingin demote <?php echo e($admin->name); ?> kembali ke Employee?"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH C:\Users\putri\Documents\Project\Bored\wengset-absensi\resources\views/livewire/owner/admin-management.blade.php ENDPATH**/ ?>